...
public class MyEpisodeConstants {
    ...
    public static final String MYEPISODES_FAVO_IGNORE_ULR = "https://www.myepisodes.com/myshows.php?action=Ignore&Ignore=1&showid=";
    public static final String MYEPISODES_FAVO_UNIGNORE_ULR = "https://www.myepisodes.com/myshows.php?action=Ignore&Ignore=0&showid=";
